...
// Return type for useUser() - combines auth user and firestore profile
...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  const userProfileRef = useMemo(() => {
    if (firestore && userAuthState.user) {
      return doc(firestore, 'userProfiles', userAuthState.user.uid);
    }
    return null;
 ...
 * This provides the User object, loading status, errors, and Firestore profile data.
 * @returns {UserHookResult} Object with user, profile, and loading/error states.
 */
