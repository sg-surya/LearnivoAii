...
import { User, Mail, Lock, School, Eye, EyeOff, Loader2 } from "lucide-react";
import { useAuth, useFirestore, setDocumentNonBlocking } from "@/firebase";
import { createUserWithEmailAndPassword, GoogleAuthProvider, signInWithPopup, sendEmailVerification, signInWithRedirect, getDoc, doc } from "firebase/auth";
...
export default function TeacherSignupPage() {
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDocumentNonBlocking(userProfileRef, userProfileData, { merge: true });
            ...
            <div className="space-y-4">
                 <div className="mb-8 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Start your journey to empower students.</p>
                    </div>
                </div>
